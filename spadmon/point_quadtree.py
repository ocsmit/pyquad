...
class PointQuadTree:
    ...
    def divide(self) -> None:
        ...
        depth = self.depth + 1
        self.nw = PointQuadTree(tiles.nw, depth=depth)
        self.ne = PointQuadTree(tiles.ne, depth=depth)
        self.se = PointQuadTree(tiles.se, depth=depth)
        self.sw = PointQuadTree(tiles.sw, depth=depth)
